<h1>Code Snippets for SQL - Postgres, MySQL, BigQuery</h1>

<h2>This repository provides a collection of practice code snippets in SQL for you to learn, experiment, and have fun with programming.</h2>
